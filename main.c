...
char printMenu(void)
{
	char i ,menu[]={" 1. Arithmatic Operations  \n 2. Number Systems  \n 3. Distance  \n 4. Curency  \n 5. Weight \n 0--> EXIT"};
Menu:
...
void NumberSystems(char *Number1,char *Number2)
{
	...
	char Arr[4][12]= {{"Decimal"},{"Binary"},{"HexaDecimal"},{"Octal"}};
...
void Distance(void)
{
	char Arr[7][11]= {{"Centi-Meter"},{"Meter"},{"Kilo-meter"},{"Miles"},{"Inches"},{"Foot"},{"Yards"}};
...
void Currency(void)
{
	...
	char Arr[9][5]= {{"INR"},{"USD"},{"EURO"},{"JPY"},{"GBP"},{"AUD"},{"CAD"},{"CNY"},{"AED"}};
	int choice1,value,choice2;
